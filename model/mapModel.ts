...
export class MapStyleTitle {
    ...
    public static getMaptitle(mapName: MapStyleTitleEnum) {
        switch (mapName) {
            case MapStyleTitleEnum.Full:
                return this.full;
            ...
            case MapStyleTitleEnum.Bright:
                return this.bright;    
            case MapStyleTitleEnum.Topo:
                return this.topo;    
            case MapStyleTitleEnum.Basic:
                return this.basic;    
            case MapStyleTitleEnum.Street:
                return this.street;    
            default:
                return this.default;
        }
